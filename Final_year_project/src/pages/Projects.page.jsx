...
import { ArrowRight, Search, Filter, CheckCircle2, Loader2, AlertCircle } from "lucide-react";
import {
  getCategoryLabel,
  PROJECT_EXTRAS_MAP,
  CATEGORY_IMAGES,
    ...
    <div className="min-h-screen bg-[#FDFCFB]">
      ...
      <section className="bg-emerald-950 py-24 text-white relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-6 relative z-10">
          <h1 className="text-4xl md:text-5xl lg:text-7xl font-bold mb-8 leading-tight tracking-tight">
            <span className="text-white/90">Restoring <span className="text-emerald-400 font-serif italic font-medium">Hope</span> <br />
            Through Direct Action </span>
          </h1>
      ...
      <section className="py-16 md:py-24 px-4 md:px-6">
        <div className="max-w-7xl mx-auto">
          ...
          {isError && (
            <div className="flex flex-col items-center justify-center py-32 gap-4 text-red-600">
              <AlertCircle className="w-10 h-10" />
              <p className="text-sm font-medium">
                {error?.data?.message ?? "Failed to load projects. Please try again."}
              </p>
            </div>
          )}
                    ...
                    <div className="relative h-64 overflow-hidden">
                      ...
                      <div className="absolute top-6 left-6 flex gap-2">
                        ...
                        {project.status === "on_hold" && (
                          <div className="px-3 py-1 bg-amber-500 rounded-full text-[9px] font-bold text-white uppercase tracking-widest shadow-sm">
                            On Hold
                          </div>
                        )}
                      </div>
